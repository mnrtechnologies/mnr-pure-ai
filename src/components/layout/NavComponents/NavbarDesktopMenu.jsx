        ...
        <NavigationMenuList>
          {navLinks.map((link) => (
            <NavigationMenuItem key={link.label}>
              <NavigationMenuTrigger className="bg-transparent text-gray-300 hover:text-white focus:text-white hover:bg-blue-700 focus:bg-blue-700">
                {link.label}
              </NavigationMenuTrigger>
              <NavigationMenuContent>
                <ul className="flex flex-col w-[350px] p-1.5 bg-gray-900 rounded-xl shadow-2xl">
